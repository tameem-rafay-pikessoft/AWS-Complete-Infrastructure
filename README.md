...
The Parameter Store module serves as a simple solution for storing application ENVIRNMENT_NAME variables (.env file). These secrets can be included during the build pipeline creation process.

### Features

- Storage of ENVIRNMENT_NAME variables.
