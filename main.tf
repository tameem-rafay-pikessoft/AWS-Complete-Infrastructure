...
module "code_pipeline_BE_module" {
  ...
  code_deploy_role_name                     = var.BE_PIPELINE_CONFIG.CODE_DEPLOY_SERVICE_ROLE_NAME
...
module "code_pipeline_FE_Admin_panel_module" {
  ...
  code_deploy_role_name                     = var.ADMIN_PANEL_PIPELINE_CONFIG.CODE_DEPLOY_SERVICE_ROLE_NAME
