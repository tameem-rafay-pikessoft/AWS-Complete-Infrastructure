...
BE_PIPELINE_CONFIG = {
  ...
  BRANCH_NAME                      = "master"
  S3_BUCKET_FOR_PIPELINE_ARTIFACTS = "development-node-project-codepipeline-artifacts"
...
ADMIN_PANEL_PIPELINE_CONFIG = {
  ...
  BRANCH_NAME                      = "master"
  S3_BUCKET_FOR_PIPELINE_ARTIFACTS = "development-next-project-codepipeline-artifacts"
  CODE_STAR_CONNECTION_ARN         = "arn:aws:codeconnections:us-east-1:905418404338:connection/d54fbc76-2224-4c40-9fbc-b0466b464dd2"
  DEPLOY_ARTIFACTS_BUCKET_NAME     = "admin-panel-fe-test-project"
